...
// ═══════════════════════════════════════════════════════
const int SLAVE_ID =9; // ⚠️ UPDATE THIS FOR EACH SLAVE!
...
void patternTwo() {
  ...
  // ── PHASE 2: THE CONVERGING CRASH ───────────────────────────────
  m3.moveTo(QTR); 
  delay(200);
  m2.moveTo(QTR); m4.moveTo(-QTR);
  delay(200);
  m1.moveTo(QTR); m5.moveTo(QTR);
  
  runAllUntilDone();
  delay(400);

  // ── PHASE 3: THE CLEAN RESET ──────────────────────────────────
  // Guaranteed return to the 5000 position
  moveAll(5000);
  delay(1000); // Hold the rest position for 1 second
}
